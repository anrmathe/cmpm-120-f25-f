// adapted from: https://phaser.io/examples/v3.85.0/game-objects/graphics/view/health-bars-demo

export class HealthBar {

    constructor (scene, x, y, color=0xff00000, width=800, height=30, border_width=3)
    {
